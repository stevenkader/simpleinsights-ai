      ...
      {response && (
        <div id="resultSection" ref={resultSectionRef} className="animate-fade-in">
          <Card className="bg-slate-50 dark:bg-slate-900 mb-8 border-2 border-gray-300 dark:border-gray-700">
            ...
            <CardContent>
              <div className="border-2 border-gray-300 dark:border-gray-700 rounded-lg p-6 min-h-[500px] overflow-auto">
                {hasError ? (
                  ...
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ __html: sanitizeHtml(cleanResponse(response)) }}
                  />
                )}
              </div>
            </CardContent>
